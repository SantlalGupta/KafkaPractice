 ...
 */
public class MyTwitterProducer {
    private Logger logger = LoggerFactory.getLogger(MyTwitterProducer.class.getName());

    public static void main(String[] args) {
        new MyTwitterProducer().run();
    }
    ...
    private KafkaProducer<String,String> createKafkaProducer() {
        ...
        properties.setProperty(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, map.get(KafkaProperty.BOOTSTRAP_SERVERS));//properties.getProperty(KafkaProperty.BOOTSTRAP_SERVERS));
